...
module.exports.run = async ({ api, event, args }) => {
    ...
    if(!args[1]) {
            ...
            api.sendMessage(`⚡️Thiếu chữ nền\n⚡️Đinh dạng: ${prefix}${this.config.name} ID/Namenv + Chữ nền + Chữ ký + Mã màu/color `, event.threadID);
    } 
    else {     
   ...
   /* function generateRandomColor() {
    ...
    const color = args[3] || colorr;
            ...
            api.sendMessage({ body: `⚡️Avata Wibu`,
